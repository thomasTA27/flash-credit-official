...
//             const response = await fetch("http://localhost:8080/flash-credit/UserServlet/signUpUser",  {
//                 method: "POST",
//                 headers: { "Content-Type": "application/json" },
//                 body: JSON.stringify({ tel, password: hashedPassword }),
//             });
